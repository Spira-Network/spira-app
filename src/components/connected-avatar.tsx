    ...
    return (
        <DropdownMenu>
            <DropdownMenuTrigger asChild>
                <Avatar className='w-8 h-8 -mr-6 border-black border-2'>
                    <AvatarImage src='https://github.com/memo.png' alt='avatar' />
                    <AvatarFallback>IC</AvatarFallback>
                </Avatar>
            </DropdownMenuTrigger>
            <DropdownMenuContent align='center' asChild>
                <ul className='box-border w-32 flex flex-col p-4 mt-4 border-t-4 rounded-none backdrop-filter bg-slate-800 bg-opacity-40 backdrop-blur-md shadow-md border-slate-600'>
