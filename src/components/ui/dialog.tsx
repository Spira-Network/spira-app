    ...
    ({ className, children, ...props }, ref) => (
        <DialogPortal>
            ...
            <Content
                ...
                {...props}>
                {children}
                <Close className='absolute right-4 top-4 rounded-full bg-[#295b7f] p-2 text-white ring-offset-background transition-opacity hover:opacity-100 focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2 disabled:pointer-events-none data-[state=open]:bg-accent data-[state=open]:text-muted-foreground'>
                    <X className='h-4 w-4' />
